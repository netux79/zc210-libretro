         ...
         if (misc == 0)
         {
            ...
            if (dir == up)
            {
               ...
               if (!hooked && _walkflag(x + 2, y + 7, 1)
                     ...
                     && combobuf[MAPDATA(x + 2, y + 7)].type != cHOOKSHOTONLY)
                  dead = 1;
            }
            ...
            if (dir == down)
            {
               ...
               if (!hooked && _walkflag(x + 12, y + 12, 1)
                     ...
                     && combobuf[MAPDATA(x + 12, y + 12)].type != cHOOKSHOTONLY)
                  dead = 1;
            }
            ...
            if (dir == left)
            {
               ...
               if (!hooked && _walkflag(x + 6, y + 13, 1)
                     ...
                     && combobuf[MAPDATA(x + 6, y + 13)].type != cHOOKSHOTONLY)
                  dead = 1;
            }
            ...
            if (dir == right)
            {
               ...
               if (!hooked && _walkflag(x + 9, y + 13, 1)
                     ...
                     && combobuf[MAPDATA(x + 9, y + 13)].type != cHOOKSHOTONLY)
                  dead = 1;
            }
         }
